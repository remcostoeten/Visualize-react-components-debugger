...
const VisualizeComponent = ({ borderTypes = 'dashed', showAlert = false, children, width = '10px', color = 'red', invert = false }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: { outline: `${width} ${borderTypes} ${color}` }, children: [children, showAlert && showToast && toastAlert()] }));
};
